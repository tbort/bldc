...
#define NTC_TEMP(adc_ind)		hw_RYSE_ESC_get_temp()
...
#define MCCONF_L_MAX_VOLTAGE			135.0	// Maximum input voltage
#endif
...
#define MCCONF_L_IN_CURRENT_MAX			125.0	// Input current limit in Amperes (Upper)
#endif
...
float hw_RYSE_ESC_get_temp(void);

#endif /* HW_RYSE_ESC_H_ */
